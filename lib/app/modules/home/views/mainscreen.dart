...
final isDesktop = screenWidth >= 1025;
  ...
  child: const App_bar(),
              ...
              // Container(
              //   color: Colors.white,
              //   width:isMobile?7777  :istablet?8888: 14440,
              //   height: 96,
              //   padding:isMobile?const EdgeInsets.only(left: 0,right: 0): const EdgeInsets.fromLTRB(64, 24, 344, 24),
              // child:App_bar() ,
              // ),
              // Main Content Area
              // Expanded(
                                    ...
                                    child: Column(
                                      children: [
                                        ...
                                        controller.update();
                                                      ...
                                                      onTap: ()=>{
                                                        // controller.fetchcoursedata2(context,controller.selectedtype)
                                                        // ,
                                                        controller.update()
                                                      },
                                                    ),
                                                  ...
                                                  Container(
                                                    ...
                                                    controller.update();
                                                        ...
                                                        // await    controller.fetchcoursedata3(context,controller.selectedmonth_by_year);
                                                      },
                                                        onTap: ()=>{
...
// Container(child:
  ...
  child: DropdownButtonFormField<String>(
    ...
    onChanged: (String? newValue) {
      ...
      // controller.fetchcoursedata4(context,controller.selectedtype2);
      controller.update();
    },
    onTap: () {
      // controller.fetchcoursedata4(context,controller.selectedtype2);
                    ...
                    //   child:
                       Wrap(
                        ...
                        children: [
                          Container(
                              width:
                                isMobile?492:  592, // Responsive width (50% of screen width)
                              height:
                                  1166, // Responsive height (80% of screen height)
                              // margin: EdgeInsets.only(
                              //   top:
                              ...
                              child: Column(children: [
                                Wrap(
                                    // crossAxisAlignment:
                                    //     CrossAxisAlignment.start,
                                    alignment:isMobile?WrapAlignment.center:
